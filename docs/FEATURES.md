...
| 4.5 | Reply nudges | If a client message has had no staff reply after the configured minutes, a nudge is posted. | Built (needs the first real Slack client message) |
