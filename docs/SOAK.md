...
Progress (14 Sep): passed A1, A2, A3, A5 (DM and Drop), A5b, A7, A13, A14, A15, B1 (yellow row confirmed), and the thread-reply part of B10. A7 needed two mail fixes first (self-sent mail was excluded as Sent; staff mail addressed To intake@ was dropped as outgoing). Open: A6, A8 (mail), A9, A10 (Slack, need 0.2), A11 (Meet, need 0.9), A12 (need PM keys).
