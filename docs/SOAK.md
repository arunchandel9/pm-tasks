...
| C2 | 4.4 | all | Read the Intake acks from block A | Created / noted on card / nothing to do and why. |
...
| C6 | 4.3 | all | Agree the rule out loud: the feed line is the receipt; no line in 2 minutes → `/task` | In the guide. |
