...
export async function GET() {
  ...
  try {
    ...
    const last = await sql()`select key, value from settings where key in ('gchat_last_event', 'pulp_poll_last', 'gmail_poll_last', 'sheet_sync_last', 'meet_poll_last', 'sheet_cards_last', 'voice_last', 'tick_last')`;
