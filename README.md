...
- Start here: `CLAUDE.md` (reading order), then `docs/ARCHITECTURE.md` (the whole system), `docs/STATE.md` (decisions, IDs, env) and `docs/FEATURES.md` (every feature and its status)
